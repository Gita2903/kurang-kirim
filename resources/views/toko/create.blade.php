...
<div class="max-w-xl mx-auto">
    ...
    <div class="flex items-center gap-4 mb-8">
        ...
        <div>
            <h1 class="text-2xl font-bold text-white">Tambah Toko Baru</h1>
            <p class="mt-0.5 text-sm text-slate-400">Isi data toko yang akan ditambahkan.</p>
        </div>
    </div>
    ...
    <div class="rounded-2xl border border-white/5 bg-white/[0.02] backdrop-blur-xl shadow-2xl shadow-black/20">
        <div class="p-6 sm:p-8">
            <form action="{{ route('toko.store') }}" method="POST" class="space-y-5">
                @csrf
                <div>
                    <label for="kode_toko" class="block text-sm font-medium text-slate-300 mb-2">Kode Toko <span class="text-rose-400">*</span></label>
                    <input type="text" id="kode_toko" name="kode_toko" value="{{ old('kode_toko') }}" required maxlength="50" placeholder="Contoh: TK001"
                ...
                <div>
                    ...
                    <input type="text" id="nama_toko" name="nama_toko" value="{{ old('nama_toko') }}" required maxlength="255" placeholder="Contoh: Indomaret Sudirman"
